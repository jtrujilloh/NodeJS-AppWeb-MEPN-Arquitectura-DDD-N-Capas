module.exports = {
	...
	Strings: {
		ErrorConexionBBDDOracle: "Ha ocurrido un error al tratar de conectarse a la Base de Datos Oracle. ",
		ErrorConexionBBDDSQLServer: "Ha ocurrido un error al tratar de conectarse a la Base de Datos Sql Server. ",
		...
		ErrorContraseñaActual: "Ha ocurrido un error al tratar de validar la contraseña actual de la cuenta. ",
		ErrorContraseñasIngresadas: "Las nuevas contraseñas ingresadas no coinciden. "
	}
};
